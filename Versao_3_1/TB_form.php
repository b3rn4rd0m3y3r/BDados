		...
		fetch(tabela, myHeaders)
			...
			.then(function (result) {
				...
				for(i=0;i<flds.length;i++){
					...
					html += "<tr><td><label>"+flds[i].Nome+"</label></td><td><input type=\""+flds[i].Tipo+"\" id=\""+flds[i].Nomestru+"\" size="+flds[i].Tamanho+"></td></tr>";
					}
				ob.getById("frm1").innerHTML = "<table>"+html+"</table>";
				return RES;
				});
		}
	</script>
